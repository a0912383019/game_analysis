...
const barChartOptions = reactive<EChartsOption>({
  ...
  legend: {
    data: [t('unit.people_num'), t('unit.amount'), t('data_name.bet_amount')]
  },
  grid: {
...
<template>
  <v-chart class="chart" :option="barChartOptions" autoresize></v-chart>
  <!-- <a-empty v-else :image="simpleImage" class="" /> -->
  <custom-table
